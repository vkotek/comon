...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="blog-item-wrap">
		<div class="post-inner-content">
			...
			<div class="countdown">
				<span class="countdown text">Zbývá</span>
				<span class="countdown days"><?php ideablog_expires(number); ?></span>
				<span class="countdown text"><?php ideablog_expires(text); ?></span>
			</div>
			
				<?php if ( 'post' == get_post_type() ) : ?>
				<div class="entry-meta">
					<?php ideablog_expires(); ?><?php if ( ! post_password_required() && ( comments_open() || '0' != get_comments_number() ) ) : ?>

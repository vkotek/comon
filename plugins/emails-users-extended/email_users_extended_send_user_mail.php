...
//error_log(print_r($_POST, true)) ;
	...
	if (array_key_exists('send', $_POST) && $_POST['send']=='true') {
		...
		$send_users = email_users_extended_get_send_users();
		if( empty( $send_users ) ) {
			$err_msg = $err_msg . __('No recipients were found.', MAILUSERS_I18N_DOMAIN) . '<br/>';
		} 
	...
	<?php
		    include('email_users_extended_user_mail_form.php');
		} else {
